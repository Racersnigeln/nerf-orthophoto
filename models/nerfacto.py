    ...
    def get_outputs(self, ray_bundle: RayBundle):
        if False:
            ...
            ray_bundle = RayBundle(origins=origins, 
                                   ...
                                   pixel_area=torch.tensor(1).view(1, 1).cuda(), 
                                   nears=torch.tensor(0.05).view(1, 1).cuda(), 
                                   fars=torch.tensor(100).view(1, 1).cuda())
            # print(f"RAY BUNDLE FARS {ray_bundle.fars}")
