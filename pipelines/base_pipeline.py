            ...
            for camera, batch in self.datamanager.fixed_indices_eval_dataloader:
                if False:
                    for i in range(100):
                        ...
                        theta *= math.pi / 180.0
                        # 90 %
                        # theta = 0.543236596352609
                        # 70 %
                        # theta = 1.4474520883319786
                        # 50 %
                        theta = 1.4034180949269623
                        phi = random.uniform(-90, 90)
                        phi *= math.pi / 180.0
                        # 90 %
                        # phi = 1.7240402776062689
                        # 70 %
                        # phi = 3.0255022248427577
                        # 50 %
                        phi = 2.118391193914775
                        # Rotate the camera around theta degrees around the x-axis and phi degrees around the y-axis
                        R1 = torch.tensor([
                        ...
                        R = R1 @ R2
                        T = 0.2* (2 * torch.rand(3) - 1)
                        # 90 %
                        # T = torch.Tensor([-0.3324,  0.0634, -0.8984])
                        # 70 %
                        # T += torch.Tensor([0.1994, 0.1675, 0.0841])
                        # 50 %
                        T = torch.Tensor([0.1219, 0.2368, 0.2026])
                        ...
                        cy = torch.Tensor([4000*scale]).view(1, 1)
